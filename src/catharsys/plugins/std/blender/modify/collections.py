...
############################################################################################
# Christian Fragen was es damit auf sich hat!!!
# Ist nicht in seinen Beispielen dokumentiert, sieht nicht wie ein ueblicher Modifier aus, so ganz ohne _dicMod
@paramclass
class CModifyCollectionsParams:
    sDTI: str = (
        CParamFields.HINT(sHint="entry point identification"),
        CParamFields.REQUIRED("/catharsys/blender/modify/collection:1.0"),
    )
...
@EntryPoint(
    ...
    clsInterfaceDoc=CModifyCollectionsParams,
)
